...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.end_time_input.setTime(QTime.currentTime().addSecs(3600))  # default +1 hour
    ...
    def handle_item_changed(self, item, column):
        if column == 7:  
            ...
            for tracked in self.items:
                if (tracked.name == name and tracked.due_date == due and tracked.start_date == start_date
                    and tracked.start_time == start_time and tracked.end_time == end_time):
    ...
    def check_notifications(self):
        if not send_notification:
            print("Notifier not available. Install pydbus nerd")
            return
